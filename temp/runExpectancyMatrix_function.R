# input: log_row
# output: player, base1~3 player and rem_type of this row
# ** use <<- to change the value of global variable
runExpectancyMatrix_function = function(dummy_list, log_row) {

# 抓安打
hit1B_function = function(dummy_list, log_row) {
  # 展開 dummy_list 的值
...
dummy_list <- hit1B_function(dummy_list, log_row)
