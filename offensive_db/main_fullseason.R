...
# anothercolbind=paste0(anothercol[,1],",",anothercol[,2])
# offensive_dbind=paste0(offensive_db[,1],",",offensive_db[,2])
# setdiff(anothercolbind,offensive_dbind)
# 
# write.csv(data.frame(anothercolbind),paste0("C:/Users/Student/Desktop/output/output04204.csv"),row.names=FALSE)
# write.csv(data.frame(offensive_dbind),paste0("C:/Users/Student/Desktop/output/output04205.csv"),row.names=FALSE)
